...
export function RecentActivity({ entries, onEntryClick }: RecentActivityProps) {
  ...
  return (
    <div className="mb-8">
      <h2 className="text-[10px] tracking-[0.4em] uppercase font-light text-slate-400 dark:text-slate-500 mb-5">
        Recent Activity
      </h2>
        ...
        {recentEntries.map((entry) => {
          ...
          return (
            <button
              ...
              className="w-full flex items-center gap-3 py-3 px-4 text-left hover:bg-[#195de6]/[0.03] dark:hover:bg-slate-800/50 rounded-xl transition-colors"
            >
